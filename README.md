...
``` json 
"dependencies": {
    "Toolbox.WebApi":  "1.4.1"
 }
``` 

ALWAYS check the latest version [here](https://github.com/digipolisantwerp/webapi_aspnetcore/blob/master/src/Toolbox.WebApi/project.json) before adding the above line !
