...
The best way to use this feature is to have you code throw exceptions that derive from the **BaseException** type defined in the [error toolbox](../master/errors_aspnetcore).
...
Some exception types that are defined in the [error toolbox](../master/errors_aspnetcore) have default mappings predefined. For these exceptions it is not nessessary to define the mappings in the configuration.
