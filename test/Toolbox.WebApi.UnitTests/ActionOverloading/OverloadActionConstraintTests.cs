...
{
    public class OverloadActionConstraintTests
    {
        [Fact]
        public void AcceptOneArgumentWithCorrectName()
        {
            ...
            context.Candidates = new List<ActionSelectorCandidate>() { new ActionSelectorCandidate(action, new[] { constraint }) };
        ...
        private RouteContext CreateRouteContext(string queryString = null, object routeValues = null)
        {
            ...
            if ( queryString != null )
            {
                httpContext.Request.QueryString = new Microsoft.AspNet.Http.QueryString(queryString);
            }
